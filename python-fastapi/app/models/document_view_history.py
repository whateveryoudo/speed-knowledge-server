...
class DocumentViewHistory(Base):
    ...
    __table_args__ = (
        UniqueConstraint('document_id', 'viewed_user_id', name='uniq_document_id_viewed_user_id'),
    ...
    viewed_user_id = Column[int](Integer,ForeignKey("user.id"), index=True, nullable=False, comment="浏览的用户")
