...
class Knowledge(Base):
    ...
    group_id = Column[str](String(36), ForeignKey("knowledge_group.id", ondelete="CASCADE"), index=True, nullable=False, comment="所属分组")
    ...
    cover_url = Column(JSON, default=default_attachment_item.model_dump(), nullable=True, comment="封面图信息")
