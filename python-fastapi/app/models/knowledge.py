...
class Knowledge(Base):
    ...
    user_id = Column[int](BigInteger, index=True, nullable=False, comment="所属用户")
    group_id = Column[int](BigInteger, index=True, nullable=False, comment="所属分组")
    icon = Column[str](String(10), nullable=False, comment="知识库图标")
    ...
    cover_url = Column[str](String(255), nullable=True, comment="封面图")
